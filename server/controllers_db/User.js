  ...
  async create(req, res) {
    try {
      if (req.user.role === 'ADMIN') {
        ...
        const createQuery = `INSERT INTO users(username,email,Role, password,created_date, modified_date)
              VALUES($1, $2, $3, $4,$5,$6) returning *`;
        const values = [req.body.username, req.body.email, req.body.Role, hashPassword, moment(new Date()),moment(new Date()) ];
        try {
